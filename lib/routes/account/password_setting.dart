...
class PasswordSetting extends StatefulWidget {
  PasswordSetting({Key? key, required this.email}) : super(key: key);
  String email;
  @override
  _PasswordSettingState createState() => _PasswordSettingState(email);
}
...
class _PasswordSettingState extends State<PasswordSetting> {
  ...
  String email;
  _PasswordSettingState(this.email);
                        ...
                        if (old_pass.text == "" ||
                          ...
                          try {
                            final data = await CallApi.changePassword(
                                email, old_pass.text, new_pass.text);
                            if (jsonDecode(data.body)['message'] ==
                                "Đã đổi thành công.") {
                              old_pass.text = "";
                              new_pass.text = "";
                              again_pass.text = "";
